...
const AddOfficialForm = ({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const bioPhotoPath = `Project/Demo/Government Management/Bio Photo/${itemName}`;
      ...
      const bioPhotoId = `{${responseUploadMedia?.Id?.toUpperCase()}}`;
      console.log('bioPhotoId', bioPhotoId);
